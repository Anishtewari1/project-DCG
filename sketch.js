...
function draw() {
  ...
  cashG.velocityY = (4+treasureCollection/10);
  diamondsG.velocityY = (4+treasureCollection/10);
  jwelleryG.velocityY = (4+treasureCollection/10);
  swordGroup.velocityY = (4+treasureCollection/10);
...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(100, 850),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(50, 750),40, 10, 10));
